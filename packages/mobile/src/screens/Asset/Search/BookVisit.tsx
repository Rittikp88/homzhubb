...
import { CollapsibleSection, Header, StateAwareComponent, TimeSlotGroup } from '@homzhub/mobile/src/components';
...
export class BookVisit extends Component<Props, IVisitState> {
  ...
  private handleSubmit = async (): Promise<void> => {
    ...
    const payload: IScheduleVisitPayload = {
      ...
      ...(params && params.userId && params.userId > 0 && { scheduled_for: params.userId }),
    };
