...
const PlatformPlanCard: FC<IProps> = (props: IProps) => {
  ...
  return (
    <View style={styles.card}>
      {servicePlanPricing && servicePlanPricing[0].banner ? (
        <View style={styles.freeTierView}>
          <Typography size="large" fontWeight="semiBold" variant="label" style={styles.mostPopularTab}>
            {servicePlanPricing[0].banner}
          </Typography>
        </View>
      ) : (
        <View style={styles.noBannerView} />
      )}
