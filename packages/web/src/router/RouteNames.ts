export const RouteNames = {
  ...
  protectedRoutes: {
    ...
    PROPERTY_DETAIL: '/dashboard/propertyDetail/:propertyName',
    ADD_LISTING: '/dashboard/nextActions',
    SEARCH_PROPERTY: '/dashboard/searchProperty',
    PROPERTY_VIEW: '/dashboard/propertyView',
    PROPERTY_SELECTED: '/dashboard/portfolio/propertySelected/:propertyName',
    SAVED_PROPERTIES: '/dashboard/savedProperties',
    OFFERS: '/dashboard/offers',
    OFFERS_LISTED_PROPERTY: '/dashboard/offers/:listingId',
    ...
    NEW_LAUNCHES: '',
    MARKET_TRENDS: '',
    SELECT_PROPERTY: '/dashboard/marketPlace/selectProperty',
    SELECT_SERVICES: '/dashboard/marketPlace/selectServices',
    VALUE_ADDED_SERVICES: '/dashboard/marketPlace',
